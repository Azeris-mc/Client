...
public class ItemAzeriumArmor extends ElementsAzerisMod.ModElement {
	...
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("AZERIUM_ARMOR", "azeris:test", 15, new int[]{2, 6, 5, 2}, 9,
		...
		}.setUnlocalizedName("azerium_armorhelmet").setRegistryName("azerium_armorhelmet").setCreativeTab(CreativeTabs.COMBAT));
