...
public class ItemAzeriumArmor extends ElementsAzerisMod.ModElement {
	...
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("AZERIUM_ARMOR", "azeris:azerium", 20, new int[]{10, 20, 25, 10}, 10,
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD).setUnlocalizedName("azerium_armorhelmet")
				.setRegistryName("azerium_armorhelmet").setCreativeTab(TabAzerisTab.tab));
